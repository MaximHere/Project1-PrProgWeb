...
<body>
    ...
    <main>
        <table class="video-details">
            <tr>
                <th class="video">
                    <iframe width="1024" height="576" src="https://www.youtube.com/embed/5umbf4ps0GQ"
        ...
        <div class="artikel">
            <div class="Desc">
                <h2 class="Title">Apa itu Olahraga Lari ?</h2>
                <br>
                <p class="text">
                    <strong id="sports">Olahraga Lari</strong> atau berlari adalah metode makhluk hidup untuk bergerak
            ...
            <div class="Desc">
                <h2 class="Title"> Cara Melakukan lari dengan Benar</h2>
                <br>
                <div class="text">
                    <p>Meski terlihat sepele, faktanya masih banyak orang yang belum tahu cara lari yang benar. Padahal,
                        ini merupakan hal yang penting untuk diperhatikan. Dengan menerapkan cara berlari yang benar,
                        Anda bisa menjalani olahraga ini dengan lancar dan terhindar dari cedera.</p>
                    <br>
                    <ul class="list">
                        ...
                        <li>Angkatlah lutut ke depan sedikit lebih tinggi, ketika Anda melakukan lari jarak jauh.
                            Sebaliknya, ketika berlari dalam jarak dekat,
                            Anda bisa menjaga posisi lutut agar lebih rendah.</li>
